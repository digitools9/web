...
INSTALLED_APPS = [
    ...
    'imgtools',  # Custom app for image manipulation
    'pdftools',  # Custom app for PDF manipulation
    'utiltools',  # Custom app for utility functions
]
...
WSGI_APPLICATION = 'digitools.wsgi.application'
